...
<div class="py-5 <?php echo $slugEN ? 'lang-en' : ''; ?>">
    <h1 class="pt-5 text-center mb-0 fs-3 text-danger fw-bold"><?= $slugEN ? get_the_title(13257) : get_the_title(9761); ?></h1>
    <?php
    ...
    <div class="custom-container">
        <div class="row justify-content-center align-items-center position-relative overflow-visible">
            <?php
            $categories_last = array();
            $categories_before = array();
            ...
            <nav id="myTab" style="background-color: <?= get_field('blog_archive_background', 'option'); ?>"
                 class="category-tabs nav-fill nav justify-content-lg-center align-items-center z-1 overflow-x-scroll position-sticky flex-nowrap justify-content-start px-0">
                ...
                foreach ($categories_before as $key => $subcat) {
                    ...
                    <a data-bs-toggle="pill" id="<?= $subcat->term_id;?>" class="button-dark button w-auto px-2 py-3 px-lg-4" href="#<?= $subcat->slug; ?>">
                        <?= $subcat->name; ?>
                    </a>
                <?php } ?>
            ...
            <div class="category-content mt-5 tab-content">
