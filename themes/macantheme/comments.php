...
<div class="my-4">
    <?php if (get_comments_number()) { ?>
        <div class="mb-4">
            <p class="h2 normal-md-down fs-2 m-0"><?= $lan == 'en' ? 'Comments' : 'نظرات شما'; ?></p>
        </div>
        <p class="fs-6 text-muted mb-4">
            <?php comments_number($lan == 'en' ? 'Your Comments' : 'یک دیدگاه ثبت شد.', $lan == 'en' ? '% Comment being Posted.' : '% دیدگاه ثبت شد.'); ?>
        </p>
    <?php } ?>
</div>
