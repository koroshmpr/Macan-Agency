...
?>
    ...
    <section class="h-100 w-100 position-relative overflow-x-hidden overflow-y-hidden">
            <h1 data-aos="fade-left" class="pt-5 ps-lg-5 text-lg-start text-center mb-0 position-absolute top-0 fs-3 text-white end-0 start-0 mt-3 mt-lg-5 z-top"><?= get_the_title() ; ?></h1>
                    ...
                    <?php while (have_rows('about_us_sections')): the_row();
                        ...
                        if ($current_row !== $total_rows) { ?>
                            <div style="background-color: <?= $color ?>"
                                ...
                                <div class="<?= $lan == 'en' ? 'text-end' : 'text-start'; ?> text-white pt-5 lh-lg">
                                    <?= $text ?>
                                </div>
                        ...
                        <?php } else { ?>
                            <div style="background-color: <?= $color ?>"
                                 class="pt-5 container-fluid d-flex justify-content-center flex-column">
                                <h6 class="<?= $lan == 'en' ? 'text-end' : 'text-start'; ?> mb-4 text-white"><?= $lan == 'en' ? "MACAN'S Values" : 'ارزش‌ها به سبک ماکان'; ?></h6>
                                <img class="img-fluid" src="<?= $image['url']; ?>" alt="<?= $image['alt']; ?>">
                                <div class="<?= $lan == 'en' ? 'text-end' : 'text-start'; ?> text-white pt-5 lh-lg">
                                    <?= $text ?>
                                </div>
