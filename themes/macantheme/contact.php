...
<?php $thumbnail_url = get_the_post_thumbnail_url(); ?>
    <section class="h-100 w-100 position-relative overflow-x-hidden overflow-y-hidden <?= $lan == 'en' ? 'lang-en' : ''; ?>" style="background-image: url('<?php echo esc_url($thumbnail_url); ?>'); background-position: right;background-repeat: no-repeat;background-size: cover;">
        <div class="container">
            <div class="row px-0 min-vh-100 <?= $lan == 'en' ? 'justify-content-lg-start ' : 'justify-content-lg-end '; ?> justify-content-center align-items-center">
