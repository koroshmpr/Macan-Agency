            ...
            <svg class="px-0" style="width: 250px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 141.73 37.65">
                <defs>
                    <style>
                        ...
                        .cls-2,.cls-3 { fill: #74489d}
                    </style>
                </defs>
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                        <path data-aos="fade-zoom-in"
                              data-aos-easing="ease-in-back"
                              data-aos-delay="300"
                              data-aos-duration="1000"
                              data-aos-offset="0" class="cls-1"
                              d="M104.17,0h37.56V37.65H104.17V0Zm4.76,4.78h28V32.87h-28V4.78Z"/>
                        <defs>
                            <clipPath id="clipPatch">
                                <rect y="0" width="35" height="40" x="105"></rect>
                            </clipPath>
                        </defs>
                        ...
                        <g data-aos="fade-down" data-aos-duration="1500">
                            <polygon class="cls-3"
                                     points="38.17 10.55 35.36 10.55 35.36 17.61 38.17 17.61 38.17 20.43 56.57 20.43 56.57 24.64 33.68 24.64 33.11 24.64 26.83 24.64 26.86 7.62 22.61 7.62 22.61 26.01 25.42 26.01 25.42 28.86 31.87 28.86 31.87 28.86 57.98 28.86 57.98 26.08 60.79 26.08 60.79 19.02 57.98 19.02 57.98 16.18 39.61 16.18 39.61 11.93 57.99 11.93 57.99 7.71 38.17 7.71 38.17 10.55"
                            />
                            <rect class="cls-3" x="5.65" y="7.59" width="4.25" height="4.22"/>
                            <polygon class="cls-3"
                                     points="14.14 24.55 4.26 24.55 4.26 13.43 0.01 13.43 0.01 24.55 0 24.55 0 28.77 15.54 28.77 15.54 25.93 18.36 25.93 18.36 13.43 14.14 13.43 14.14 24.55"/>
                            <path class="cls-3"
                                  d="M91.92,14.67V11.86H80.55v2.81H77.74v10H69.29v-17H65V26.05h2.85v2.81h24V26.05h2.85V14.67Zm-1.41,10H82V16.11h8.55Z"/>
                            <line class="cls-3" x1="65.04" y1="22.29" x2="65.04" y2="18.04"/>
                        </g>
                    </g>
                </g>
            </svg>
