...
global $lan;
?>
<div class="col-lg-6 position-relative <?= $lan == 'en' ? ' order-1 order-lg-2 ' : ' '; ?>">
...
<div class="col-lg-6 row justify-content-center align-content-center mb-5 z-1 pt-4 pt-lg-0 z-2 <?= $lan == 'en' ? 'order-2 order-lg-1 ' : ' '; ?>">
